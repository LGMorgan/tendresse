...
<section>
	{#if showTitle}
		<h3>Si tu as la moindre question n'hésite pas à m'écrire !</h3>
	{/if}
	<div class="mx-5 flex items-center justify-center gap-10">
		<a
			class="flex gap-2"
		...
		<a href="mailto:les.ateliers.tendresse@gmail.com"> 💌 les.ateliers.tendresse@gmail.com </a>
	</div>
</section>
